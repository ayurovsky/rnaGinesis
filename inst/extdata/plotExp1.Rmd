...
#experiment1$trueW <- lapply(experiment1$trueW, function(X) log1p(X[1:5000,]))
#experiment1$ex <- log1p(experiment1$ex[1:5000,])
#experiment1$trueW <- lapply(experiment1$trueW, function(X) X[1:5000,])
#experiment1$ex <- experiment1$ex[1:5000,]
experiment1$trueW <- lapply(experiment1$trueW, function(X) X[1:100,])
experiment1$ex <- experiment1$ex[1:100,]
...
load("~/rnaGinesis/data/exp1.NMF.result.RData")
#exp1.NMF[[1]] <- lapply(exp1.NMF[[1]], function(X) X[1:5000,])
exp1.NMF[[1]] <- lapply(exp1.NMF[[1]], function(X) X[1:100,])
#load("~/rnaGinesis/data/alisa_orig_A_mu_exp1_no_noise.NMF.result.RData")
...
load("~/rnaGinesis/data/exp1.CIBERSORT.result.RData")
#load("~/rnaGinesis/data/alisa_orig_A_mu_exp1_no_noise.CIBERSORT.result.RData")
#load("~/rnaGinesis/data/alisa_new_A_mu_exp1_no_noise.CIBERSORT.result.RData")

#load("~/rnaGinesis/data/exp1_5000-100features_CIBERSORT.result.RData")
#exp1.CIBERSORT <- rearrange(exp1.CIBERSORT, experiment1)
#resultW.CIBERSORT <- exp1.CIBERSORT[[1]]
#resultH.CIBERSORT <- exp1.CIBERSORT[[2]]

load("~/rnaGinesis/data/exp1_100_DEMIXT.result.RData")
exp1.DEMIXT <- rearrange(exp1.DEMIXT, experiment1)
resultW.DEMIXT <- exp1.DEMIXT[[1]]
resultH.DEMIXT <- exp1.DEMIXT[[2]]
