...
#load("~/rnaGinesis/rnaGinesis/data/exp3.DeMixT.result.RData")
...
load("~/rnaGinesis/data/exp3.CIBERSORT.result.RData")

# A HACK, because exp3 results were not properly processed, and the original cibersort output is not saved
# this line should move to run3.CIBERSORT.rmd for the future
